...
- (void)testCompletesIntegrationServerURLs
{
	...
	STAssertEquals((NSUInteger)8, [urls count], @"Should have returned only expected urls.");
}
...
- (void)testOnlyReturnsOneCompleteURLWhenURLWasComplete
{
	...
	STAssertEquals((NSUInteger)1, [urls count], @"Should have returned only one urls.");
}
