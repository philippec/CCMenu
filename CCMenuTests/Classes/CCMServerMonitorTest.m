...
- (void)testSetsUpProjectsAndConnectionsFromDefaults
{
    ...
    STAssertEquals((NSUInteger)3, [[monitor projects] count], @"Should have created right number of projects.");
    ...
    STAssertEquals((NSUInteger)2, [[monitor connections] count], @"Should have created minimum number of connection.");
